  ...
  return (
    <section className="card-panel space-y-3 border-destructive/40 bg-destructive/10">
      <div className="flex flex-wrap items-center gap-2">
        <span className="inline-flex items-center gap-1.5 rounded-full border border-destructive/40 bg-destructive/15 px-3 py-1 text-xs font-medium text-destructive">
