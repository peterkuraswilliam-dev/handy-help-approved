...
export const Route = createFileRoute("/auth")({
  validateSearch: (_s: Record<string, unknown>) => ({ mode: "signin" as const }),
  head: () => ({
    meta: [
      { title: "Contractor Sign In — Handy Help Aberdeenshire" },
      {
        name: "description",
        content:
          "Sign in to Handy Help Aberdeenshire. New contractor accounts require an invitation.",
      },
    ],
  }),
  component: AuthPage,
...
function AuthPage() {
  ...
  async function forgotPassword() {
    ...
    if (!emailOk.success)
      return toast.error("Enter your email address first, then choose Reset password.");
    setLoading(true);
    try {
  ...
  return (
    <div className="max-w-md mx-auto space-y-4">
      ...
      <div className="card-panel">
        <h2 className="mb-2 text-xl font-semibold">Contractor sign in</h2>
        <p className="mb-4 text-sm text-muted-foreground">
          New contractor accounts can only be created through a secure invitation from Handy Help.
        </p>
        ...
        >
          <svg width="18" height="18" viewBox="0 0 48 48" aria-hidden="true">
            <path
              fill="#FFC107"
              d="M43.6 20.5H42V20H24v8h11.3C33.7 32.4 29.3 35.5 24 35.5c-6.4 0-11.5-5.1-11.5-11.5S17.6 12.5 24 12.5c2.9 0 5.6 1.1 7.6 2.9l5.7-5.7C33.9 6.5 29.2 4.5 24 4.5 13.2 4.5 4.5 13.2 4.5 24S13.2 43.5 24 43.5 43.5 34.8 43.5 24c0-1.2-.1-2.4-.3-3.5z"
            />
            <path
              fill="#FF3D00"
              d="M6.3 14.7l6.6 4.8C14.6 16 19 12.5 24 12.5c2.9 0 5.6 1.1 7.6 2.9l5.7-5.7C33.9 6.5 29.2 4.5 24 4.5 16.3 4.5 9.7 8.8 6.3 14.7z"
            />
            <path
              fill="#4CAF50"
              d="M24 43.5c5.2 0 9.8-2 13.3-5.2l-6.2-5.2c-2 1.5-4.5 2.4-7.1 2.4-5.3 0-9.7-3.1-11.3-7.5l-6.5 5C9.6 39.1 16.2 43.5 24 43.5z"
            />
            <path
              fill="#1976D2"
      ...
      <p className="text-center text-xs text-muted-foreground">
        ...
        <a
          ...
          className="text-[color:var(--color-gold)] underline underline-offset-2"
        >
          community rules
        </a>
        . See our{" "}
        <a href="/privacy" className="text-[color:var(--color-gold)] underline underline-offset-2">
          privacy information
        </a>
        .
      </p>
